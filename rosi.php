	...
	<head>		
		...
		<script>
			$(document).ready(function(){
				$("#nav_rosi").addClass("current_page");
			});
		</script>
	</head>
<body>
	...
	absolviert und wurde vom BDY/EYU geprüft. Seit dem leite ich mit viel Freude selbständig
	Kurse und besuche regelmäßig Fortbildungen und Meditationskurse. <br>
	Von 2009-2010 habe ich eine Weiterbildung in „Therapeutischer Anwendung des Yoga“ in der Tradition
	von Professor <a href="#yogameister">T.Krishnamacharia</a> und <a href="#yogameister">TKV Desikachar</a> absolviert und bin dadurch qualifi ziert
