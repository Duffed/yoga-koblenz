...
<body>
	...
	die Erfahrung des tiefen Kerns unseres Bewusstseins.</p>

	<h2>Geschichte des Yoga</h2>
	<p>
	...
	<h2 id="yogasutra">Yogasutra</h2>	
		...
		<a class="yogasutra_link yogasutra_hide info-text pointer">weiterlesen</a>
		<!-- Container (toggle) -->
		<div class="yogasutra_container">
			...
			Es ist mit nur 195 Sätzen sehr kurz, jeder Einzelne sehr gehaltvoll.
			Die Sätze gleichen kostbaren Perlen, die durch einen Faden, dem Sutra, wie zu einer Perlenkette zusammengefügt und dadurch zu einem
			wertvollen Ganzen werden.</p>

			<p>In den vergangenen beiden Jahrtausenden gab es viele Kommentare zum Yogasutra.
			...
			Schwierigkeiten zu finden. Es bietet viele Lösungsmodelle für unterschiedliche Fragen, die sich
			auch in unserem modernen Leben stellen."</p>

			<p>Im zweiten der insgesamt vier Kapitel gibt Patanjali Anleitung zu Körperübungen: </p>
			<p><b class="green">a)</b> kraftvoll üben und dabei leicht und unverkrampft bleiben <br>
			<b class="green">b)</b> die Aufmerksamkeit des Geistes nicht verändern, sondern auf etwas Konstantes ausrichten.</p>

			<p>und beschreibt den bekannten achtgliedrigen Pfad des Yoga:</p>

			<table>
				<tr>
					<th>1. Yamas</th>
					<td>Verhaltensweisen, die ein friedliches Leben im Einklang mit sich selbst und
						der Welt fördern: <br>
